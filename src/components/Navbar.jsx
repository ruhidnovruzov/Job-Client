            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-8">
                ...
                {user.token ? (
                  ...
                  <Link
                    to="/auth"
                    className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-xl shadow-lg ${isScrolled
          ...
          <div className={`px-4 py-6 space-y-3 ${isScrolled
            ...
            {user.token ? (
              ...
              <Link
                to="/auth"
                onClick={() => setIsMobileMenuOpen(false)}
                className={`block px-4 py-3 mx-2 text-center rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg ${isScrolled
